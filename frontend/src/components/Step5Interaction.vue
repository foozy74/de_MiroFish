        ...
        <div class="action-bar-header">
          ...
          <div class="action-bar-tabs">
            ...
            >
              ...
              <span>Mit Report Agent chatten</span>
            </button>
            <div class="agent-dropdown" v-if="profiles.length > 0">
              ...
              >
                ...
                <span>{{ selectedAgent ? selectedAgent.username : 'Mit beliebiger Entität chatten' }}</span>
              ...
              <div v-if="showAgentDropdown" class="dropdown-menu">
                ...
                >
                  ...
                  <div class="agent-info">
                    ...
                    <span class="agent-role">{{ agent.profession || 'Unbekannte Beruf' }}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <span>Umfrage an die Welt senden</span>
            </button>
          </div>
        </div>
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Schnellchat-Version des Report-Agenten mit 4 professionellen Tools und vollständigem MiroFish-Gedächtnis</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Gleicht Realitäts-Seed-Daten mit Simulationsumgebungszuständen ab und bietet zeitübergreifende Tiefenattributionsanalyse</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">PanoramaSearch Panoram tracking</div>
                    <div class="tool-desc">Rekonstruiert Ereignisverbreitungspfade durch Graph- breadth-first Algorithmus und erfasst die topologische Struktur des vollständigen Informationsflusses</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Sofortige Abfrage-Schnittstelle basierend auf GraphRAG für schnelle Extraktion von Knotenattributen und diskreten Fakten</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonome Interviews mit mehreren Runden, die parallel mit Individuen in der Simulationswelt geführt werden, sammeln unstrukturierte Meinungsdaten und psychische Zustände</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div v-if="chatTarget === 'agent' && selectedAgent" class="agent-profile-card">
            <div class="profile-card-header">
              ...
              <div class="profile-card-info">
                ...
                <div class="profile-card-meta">
                  ...
                  <span class="profile-card-profession">{{ selectedAgent.profession || 'Unbekannte Beruf' }}</span>
                </div>
              </div>
            ...
            <div v-if="showFullProfile && selectedAgent.bio" class="profile-card-body">
              <div class="profile-card-bio">
                <div class="profile-card-label">Biografie</div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Mit Report Agent chatten, um den Bericht zu verstehen' : 'Mit simuliertem Individuum chatten, um seine Meinungen zu verstehen' }}
              </p>
            </div>
            <div 
          ...
          <div class="survey-setup">
            <div class="setup-section">
              <div class="section-header">
                <span class="section-title">Zielgruppe auswählen</span>
              ...
              <div class="agents-grid">
                ...
                >
                  ...
                  <div class="checkbox-info">
                    ...
                    <span class="checkbox-role">{{ agent.profession || 'Unbekannte Rolle' }}</span>
                  </div>
            ...
            <div class="setup-section">
              <div class="section-header">
                <span class="section-title">Fragebogen-Frage</span>
              </div>
              <textarea 
                v-model="surveyQuestion"
                class="survey-input"
                placeholder="Frage an alle ausgewählten Personen eingeben..."
                rows="3"
              ></textarea>
            </div>
            ...
            >
              ...
              <span v-else>Fragebogen senden</span>
            </button>
          </div>
              ...
              >
                <div class="result-header">
                  ...
                  <div class="result-info">
                    ...
                    <span class="result-role">{{ result.profession || 'Unbekannte Rolle' }}</span>
                  </div>
                </div>
...
import { chatWithReport, getAgentLog, getReport } from "../api/report";
import {
