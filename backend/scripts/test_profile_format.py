"""
Testet, ob die Profile-Formatgenerierung den OASIS-Anforderungen entspricht
Validierung:
1. Twitter Profile werden im CSV-Format generiert
2. Reddit Profile werden im JSON-Detailformat generiert
"""
...
def test_profile_formats():
    """Testet die Profile-Formate"""
    print("=" * 60)
    print("OASIS Profile-Format Test")
    print("=" * 60)
    
    # Test-Profile-Daten erstellen
    test_profiles = [
        OasisAgentProfile(
            user_id=0,
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        # Twitter CSV-Format testen
        print("\n1. Twitter Profile testen (CSV-Format)")
        print("-" * 40)
        generator._save_twitter_csv(test_profiles, twitter_path)
        
        # CSV lesen und validieren
        ...
        if missing:
            ...
            print(f"\n   [Bestanden] Alle Pflichtfelder vorhanden")
        
        # Reddit JSON-Format testen
        print("\n2. Reddit Profile testen (JSON-Detailformat)")
        print("-" * 40)
        ...
        # Detailformat-Felder validieren
        ...
        if missing:
            print(f"\n   [Fehler] Fehlende Pflichtfelder: {missing}")
        else:
            print(f"\n   [Bestanden] Alle Pflichtfelder vorhanden")
...
def show_expected_formats():
    """Zeigt die von OASIS erwarteten Formate"""
    print("\n" + "=" * 60)
    print("OASIS erwartete Profile-Formatreferenz")
    print("=" * 60)
...
1,user1,User One,Tech enthusiast and coffee lover.,200,250,1000,2023-01-02"""
    ...
    print("\n2. Reddit Profile (JSON-Detailformat)")
    print("-" * 40)
    reddit_example = [
        {
