"""
Aktions-Protokollierer
Zur Protokollierung der Aktionen jedes Agenten in der OASIS-Simulation zur Backend-Überwachung
...
class PlatformActionLogger:
    """Einzelplattform-Aktions-Protokollierer"""
    ...
    def log_simulation_start(self, config: Dict[str, Any]):
        """Simulationsstart protokollieren"""
        entry = {
            "timestamp": datetime.now().isoformat(),
    ...
    def log_simulation_end(self, total_rounds: int, total_actions: int):
        """Simulationsende protokollieren"""
        entry = {
            "timestamp": datetime.now().isoformat(),
...
class SimulationLogManager:
    """
    Simulations-Protokollmanager
    Zentrales Management aller Protokolldateien, nach Plattform getrennt
    """
    
    def __init__(self, simulation_dir: str):
        """
        Protokollmanager initialisieren
        ...
        # Hauptprotokoll einrichten
        self._setup_main_logger()
    
    def _setup_main_logger(self):
        """Hauptsimulationsprotokoll einrichten"""
    ...
    def get_twitter_logger(self) -> PlatformActionLogger:
        """Twitter-Plattform-Protokollierer abrufen"""
    ...
    def get_reddit_logger(self) -> PlatformActionLogger:
        """Reddit-Plattform-Protokollierer abrufen"""
...
class ActionLogger:
    """
    Aktions-Protokollierer (für alte Schnittstelle)
    Nutzung von SimulationLogManager wird empfohlen
    """
...
# Globale Protokollinstanz (für alte Schnittstelle)
_global_logger: Optional[ActionLogger] = None


def get_logger(log_path: Optional[str] = None) -> ActionLogger:
    """Globale Protokollinstanz abrufen (für alte Schnittstelle)"""
