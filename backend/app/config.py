...
Lädt Konfigurationen einheitlich aus der .env-Datei im Projektstammverzeichnis
"""

import os
from dotenv import load_dotenv

# Lädt die .env-Datei im Projektstammverzeichnis
...
if os.path.exists(project_root_env):
    ...
    # Falls im Stammverzeichnis keine .env vorhanden ist, versuche Umgebungsvariablen zu laden (für Produktionsumgebungen)
...
class Config:
    ...
    DEFAULT_CHUNK_OVERLAP = 50  # Standard-Overlap-Größe
